...
const techGroups = [
  {
    ...
    items: [
      ...
      { name: 'Rust', icon: 'https://cdn.jsdelivr.net/gh/devicons/devicon/icons/rust/rust-original.svg', docs: 'https://doc.rust-lang.org/stable/' },
  ...
  },
  {
    ...
    items: [
      ...
      { name: 'Laravel', icon: 'https://cdn.jsdelivr.net/gh/devicons/devicon/icons/laravel/laravel-original.svg', docs: 'https://laravel.com/docs/12.x' },
