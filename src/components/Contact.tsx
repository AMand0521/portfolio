        ...
        <div className="flex justify-center">
          <div id="SocailIcons" className="relative">
            ...
            <a href="https://t.me/JackDavid31" target="_blank" rel="noopener noreferrer" className="icons linkedin group">
              ...
              <div className="icon link">
                <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24">
                  <path d="M9.964 15.568l-.396 5.568c.566 0 .812-.244 1.106-.535l2.652-2.558 6.152 4.513c1.127.623 1.933.295 2.228-1.04l4.03-18.862h.001c.369-1.628-.59-2.266-1.683-1.868L1.49 9.24c-1.6.622-1.577 1.51-.289 1.912l5.643 1.76L19.207 5.6c.602-.404 1.153-.18.701.224"/>
                </svg>
              </div>
            </a>
